                    ...
                    <section className="home" id="h">
                        <div className="content">
                            ...
                            <p>I am a computer science student with a deep passion for technology and problem-solving. My journey began with a
                                fascination for computers and programming languages like Python,Java, C++, HTML, CSS, JavaScript, and MySQL.</p>
                ...
                <section className="Qua" id="q">
                    ...
                    <div className="qualification">
                        <div>
                            ...
                            <h2 className="clgname">Vasishta English Medium High school </h2>
                            <h4>Madanapalli</h4>
                            <h4>Annamayya</h4>
                        </div>
                        <div>
                            <h1 className="heading">Intermediate</h1>
                            <h2 className="clgname">Bharathi Junior College </h2>
                            <h4>MPC</h4>
                            <h4>Madanapalli</h4>
                        </div>
                        <div>
                ...
                <section className="forth C" id="s">
                    ...
                    <section className="scroll-container ">
                        <section className="third">
                            <div><img src="https://th.bing.com/th/id/OIP.JSFxwBimPjrahtawCu5LRwHaHZ?w=188&h=187&c=7&r=0&o=5&dpr=1.3&pid=1.7.jpg"alt=""/></div>
